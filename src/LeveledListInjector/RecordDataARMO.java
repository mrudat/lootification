...
public class RecordDataARMO extends RecordData {
    ...
    public RecordDataARMO(String id, String mod) {
        super(id, mod, GRUP_TYPE.ARMO);
    }
    
    public RecordDataARMO(MajorRecordNamed rec) {
        super(rec);
    }
